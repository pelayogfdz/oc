      ...
      <div className="a4-container">
        ...
        <div style={{ position: 'absolute', bottom: '2cm', left: '2cm', right: '2cm' }}>
          <div className="qr-section">
            <img src={`https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=https://clientes.caanma.com?traspasoId=${transfer.id.slice(0, 8)}`} alt="QR Code" style={{ width: '80px', height: '80px' }} />
            <div>
