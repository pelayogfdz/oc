    ...
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
        ...
        <div>
          ...
          <p style={{ color: 'var(--pulpos-text-muted)' }}>Conexión Mirakl B2B2C / Catálogo Extendido.</p>
        </div>
      </div>
      ...
      <div className="card" style={{ padding: '2rem', marginBottom: '2rem' }}>
        ...
        <form action={saveIntegrationTokens} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <input type="hidden" name="platform" value="LIVERPOOL" />
          
          <div>
            <label style={{ display: 'block', fontWeight: 'bold', marginBottom: '0.25rem', color: 'var(--pulpos-primary)' }}>API Token</label>
            <input 
              type="text" 
              name="accessToken"
              required
