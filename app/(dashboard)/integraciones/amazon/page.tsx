    ...
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
        ...
        <div>
          ...
          <p style={{ color: 'var(--caanma-text-muted)' }}>Mapeo y simulación FBA/FBM.</p>
        </div>
      </div>
      ...
      <div className="card" style={{ padding: '2rem', marginBottom: '2rem' }}>
        ...
        <form action={saveIntegrationTokens} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <div>
            <label style={{ display: 'block', fontWeight: 'bold', marginBottom: '0.25rem', color: 'var(--caanma-primary)' }}>Access Token de Producción</label>
            <input 
              type="text" 
              name="accessToken"
              required
