      ...
      <div className="table-responsive">
        ...
        <thead>
          <tr style={{ borderBottom: '1px solid var(--caanma-border)', backgroundColor: '#f9fafb' }}>
            ...
            <th style={{ padding: '0.5rem 0.75rem', fontWeight: '500', color: 'var(--caanma-text-muted)', whiteSpace: 'nowrap' }}>Fecha</th>
            <th style={{ padding: '0.5rem 0.75rem', fontWeight: '500', color: 'var(--caanma-text-muted)', whiteSpace: 'nowrap' }}>Cliente</th>
            <th style={{ padding: '0.5rem 0.75rem', fontWeight: '500', color: 'var(--caanma-text-muted)', whiteSpace: 'nowrap' }}>Creado por</th>
            <th style={{ padding: '0.5rem 0.75rem', fontWeight: '500', color: 'var(--caanma-text-muted)', whiteSpace: 'nowrap' }}>Total</th>
            <th style={{ padding: '0.5rem 0.75rem', fontWeight: '500', color: 'var(--caanma-text-muted)', whiteSpace: 'nowrap' }}>Estado</th>
            <th style={{ padding: '0.5rem 0.75rem', fontWeight: '500', color: 'var(--caanma-text-muted)', textAlign: 'right', whiteSpace: 'nowrap' }}>Acción</th>
          </tr>
        </thead>
        <tbody>
