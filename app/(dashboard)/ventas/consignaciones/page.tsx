    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto', fontFamily: 'var(--font-geist-sans)' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        <div>
          ...
          <p style={{ color: 'var(--caanma-text-muted)', marginTop: '0.25rem' }}>Administra la mercancía entregada a clientes en consignación. El stock ya fue deducido.</p>
        </div>
        ...
        <table className="responsive-table" style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
          ...
          <tbody>
              ...
              <tr key={consignment.id} style={{ borderBottom: '1px solid var(--caanma-border)', transition: 'background-color 0.15s' }}>
                ...
                <td data-label="Acciones" style={{ padding: '1.25rem 1rem', textAlign: 'right' }}>
                  {consignment.status === 'ACTIVE' ? (
                    ...
                    <span style={{ fontSize: '0.85rem', color: 'var(--caanma-text-muted)', fontStyle: 'italic' }}>
                      Venta Cerrada
                    </span>
                  )}
                </td>
            ...
            {consignments.length === 0 && (
              <tr>
                <td colSpan={8} style={{ padding: '5rem 2rem', textAlign: 'center', color: 'var(--caanma-text-muted)' }}>
