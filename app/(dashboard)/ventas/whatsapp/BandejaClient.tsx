...
export default function BandejaClient({ initialProspects, users, currentUser, customers = [] }: any) {
    ...
    if (prospects && prospects.length > 0) {
      ...
      if (newestIncomingMessage) {
        ...
        if (msgTime > lastCheckedTime) {
          if (selectedProspectId !== newestProspect.id) {
  ...
  return (
    <div style={{ display: 'flex', height: '100%', position: 'relative' }}>
      ...
      {/* Floating Messenger-style WhatsApp Widget in bottom-right */}
      <div style={{ 
        position: 'fixed', 
        bottom: '24px', 
        right: '24px', 
                    ...
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
                      ...
                      >
                        <input 
                          ...
                          disabled={isSendingFloatingReply}
                          style={{
                            flex: 1,
                            padding: '8px 12px',
                            borderRadius: '20px',
