  ...
  return (
    <div style={{ maxWidth: '900px', margin: '0 auto' }}>
      <div style={{ display: 'flex', alignItems: 'center', marginBottom: '2rem', gap: '1rem' }}>
        <Link href="/proveedores" style={{ textDecoration: 'none', color: 'var(--pulpos-text-muted)', fontSize: '1.25rem' }}>← Volver a Proveedors</Link>
      ...
      <form action={saveAction} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '1rem', marginTop: '1rem' }}>
           <Link href="/proveedores" style={{ padding: '0.75rem 2rem', textDecoration: 'none', color: 'var(--pulpos-text)', border: '1px solid var(--pulpos-border)', borderRadius: '4px', fontWeight: 'bold' }}>Cancelar</Link>
