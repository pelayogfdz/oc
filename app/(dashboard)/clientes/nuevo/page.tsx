        ...
        <div className="card" style={{ padding: '1.5rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1fr) minmax(0,1fr)', gap: '1.5rem' }}>
            ...
            <div>
              ...
              <input type="tel" name="phone" required placeholder="10 dígitos" style={{ width: '100%', padding: '0.75rem', borderRadius: '4px', border: '1px solid var(--caanma-border)' }} />
            </div>
            <div style={{ gridColumn: 'span 2' }}>
              ...
              <input type="email" name="email" required placeholder="cliente@correo.com" style={{ width: '100%', padding: '0.75rem', borderRadius: '4px', border: '1px solid var(--caanma-border)' }} />
            </div>
            <div style={{ gridColumn: 'span 2' }}>
        ...
        <div className="card" style={{ padding: '1.5rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1fr) minmax(0,2fr)', gap: '1.5rem', marginBottom: '1.5rem' }}>
            ...
            <div>
              ...
              <input type="text" name="legalName" style={{ width: '100%', padding: '0.75rem', borderRadius: '4px', border: '1px solid var(--caanma-border)' }} />
            </div>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1fr) minmax(0,1fr) minmax(0,1fr)', gap: '1.5rem' }}>
            <div>
