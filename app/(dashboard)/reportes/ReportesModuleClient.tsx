...
export default function ReportesModuleClient({ 
  ...
  const reports = [
    ...
    { title: 'Compras vs Stock Remanente', icon: <Package size={24} color="#8b5cf6" />, description: 'Rastreo de productos comprados, existencias vivas remanentes, costo y capital inmovilizado.', route: '/reportes/compras-remanente', requiredPermission: 'report_purchases_remaining' },
    { title: 'Productos por Ubicación', icon: <Package size={24} color="#0d9488" />, description: 'Auditoría y listado de productos agrupados por su ubicación física con impresión de etiquetas.', route: '/reportes/ubicacion', requiredPermission: 'report_valued_inventory' },
    ...
    { title: 'Historial de Precios', icon: <Tag size={24} color="#8b5cf6" />, description: 'Historial de cambios de precio por producto, lista de precio y usuario.', route: '/reportes/historial-precios', requiredPermission: 'report_costs_prices' },
    ...
    { title: 'Reposición de Mínimos', icon: <Package size={24} color="#dc2626" />, description: 'Listado de artículos con stock por debajo del mínimo para reposición inmediata.', route: '/reportes/reposicion-minimos', requiredPermission: 'report_replenishment' },
