import { getInsumosReportData, getAvailableFilters } from "@/app/actions/reportes";
...
export default async function InsumosPage() {
  ...
  // Get initial insumos data
  const data = await getInsumosReportData(startDate, endDate, initialBranchId, 'ALL');
