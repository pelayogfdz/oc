          ...
          {filteredPurchases.map(purchase => (
            ...
            >
              ...
              <div style={{ padding: '1rem 1.25rem', backgroundColor: '#f8fafc', borderTop: '1px solid var(--caanma-border)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span style={{ fontSize: '0.85rem', color: 'var(--caanma-text-muted)' }}>{purchase.items?.length || 0} artículos</span>
                <span style={{ fontSize: '1.25rem', fontWeight: '900', color: 'var(--caanma-primary)' }}>
